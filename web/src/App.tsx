...
export function AppLayout() {
  ...
  return (
    <>
      ...
      <main
        className={cn(
          "bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.92),_rgba(245,239,231,0.96)_42%,_rgba(240,235,227,0.99)_100%)] text-stone-900 transition-colors duration-300 dark:bg-[radial-gradient(circle_at_top_left,_rgba(55,48,43,0.72),_rgba(28,25,23,0.98)_40%,_rgba(12,10,9,1)_100%)] dark:text-stone-100",
          isLoginPage ? "h-dvh overflow-hidden" : "min-h-screen overflow-x-hidden",
        )}
        style={{
          fontFamily:
